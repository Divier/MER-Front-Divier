 ...
 */
@XmlRootElement
public class ResponseDataConstructoras {
    ...
    public ResponseDataConstructoras() {
    }

    public ResponseDataConstructoras(String responseString) {
        String[] spliter;
        ...
        if (spliter.length > 0) {
            ...
            telefono1 = spliter[2];
            telefono2 = spliter[3];
            correoElectronico = spliter[4];
            nombreContacto = spliter[5];
            direccion = spliter[6];
            observacion1 = spliter[7];
            observacion2 = spliter[8];
            observacion3 = spliter[9];
            observacion4 = spliter[10];
            observacion5 = spliter[11];
