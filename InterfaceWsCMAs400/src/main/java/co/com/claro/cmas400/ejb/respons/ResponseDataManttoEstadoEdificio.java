 ...
 */
@XmlRootElement
public class ResponseDataManttoEstadoEdificio {
    ...
    public ResponseDataManttoEstadoEdificio() {
    }

    public ResponseDataManttoEstadoEdificio(String responseString)  {
        String[] spliter;
        ...
        if (spliter.length > 0) {
            ...
            estado = spliter[2];
            validarEstado = spliter[3];
            excepcionRadiografia = spliter[4];
        }
    }
