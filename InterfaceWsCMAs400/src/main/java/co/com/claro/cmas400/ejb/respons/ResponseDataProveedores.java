 ...
 */
@XmlRootElement
public class ResponseDataProveedores {
    ...
    public ResponseDataProveedores() {
    }

    public ResponseDataProveedores(String responseString)  {
        String[] spliter;
        ...
        if (spliter.length > 0) {
            ...
            email1 = spliter[9];
            email2 = spliter[10];
            paginaWeb = spliter[11];
            personaContacto1 = spliter[12];
            personaContacto2 = spliter[13];
            personaContacto3 = spliter[14];
        }
    }
