 ...
 * @author User
 */
public class RestClientBasicMaintenanceRRCenterPopulated {

    private static final Logger LOGGER = LogManager.getLogger(RestClientBasicMaintenanceRRCenterPopulated.class);
     ...
     */
    public RestClientBasicMaintenanceRRCenterPopulated(String baseUri) {
        ClientConfig config = new DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(baseUri).path(Constants.REST_BASICARR_POPULATED_CENTER_SERVICE);
    }
    ...
    public <T> T callWebServiceMethodPut(EnumeratorServiceName enumeratorServiceName,
        ...
        try {
            ...
            throw new ApplicationException("Error en ProxyRR:RestClientBasicMaintenanceRRCenterPopulated: " + ae.getMessage(), ae);
        }
