...
import co.com.telmex.catastro.mbeans.comun.cataloglb.CatalogQueryBussiness;
...
/**
 * Clase CatalogQuerySrv
 * Extiende de HttpServlet
 *
 * @author 	Ana María Malambo
 * @version	1.0
 */
public class CatalogQuerySrv extends HttpServlet {
    
    private static final Logger LOGGER = LogManager.getLogger(CatalogQuerySrv.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        CatalogQueryBussiness catalogQueryBussiness = new CatalogQueryBussiness();

        List CatalogDetails = null;
        try {
            catalogQueryBussiness.buildResul(request, response, ctlid, nombret);
