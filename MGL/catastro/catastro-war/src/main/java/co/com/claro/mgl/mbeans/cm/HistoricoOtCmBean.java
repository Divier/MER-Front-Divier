 ...
 * @author cardenaslb
 */
@ManagedBean(name = "historicoOtCmBean")
@SessionScoped
public class HistoricoOtCmBean {
    ...
    private static final Logger LOGGER = LogManager.getLogger(HistoricoOtCmBean.class);
    @EJB
    ...
    private List<ReporteHistoricoOtCmDto> listReporteHistoricoOtCmDto;
    ...
    private static String[] NOM_COLUMNAS = {"Numero Ot",
        "Tipo OT MER","SubTipo OT MER", "Est. Interno OT MER", "Est.Interno OT[Audit]","Fecha creacion OT MER","Fecha creacion OT MER [Audit]","Fecha Modificacion",
        "Segmento OT MER", "Segmento OT MER[Audit]","Tecnologia OT MGL", "Codigo CCMM", "Codigo CCMM RR","Nombre CCMM", "Usuario CREACION OT MER",
        "Usuario EDICION OT MER","Usuario EDICION OT MER[Audit]","OT hija ONYX", "OT hija ONYX[Audit]","Departamento",
        "N° Orden RR","Sub tipo orden OFSC","Sub tipo orden OFSC[Audit]","Fecha Agenda","Usuario Creacion Agenda",
        "Usuario Edicion Agenda","Usuario Edicion Agenda[Audit]","Time Slot",
        "Estado Agenda", "Estado Agenda[Audit]","Fecha Ini Agend","Fecha Ini Agend[Audit]",
        "Fecha Fin Agend","Fecha Fin Agend[Audit]","Id Aliado","Id Aliado[Audit]","Nombre Aliado","Nombre Aliado[Audit]",
        "Id Tecnico","Id Tecnico[Audit]","Nombre Tecnico","Nombre Tecnico[Audit]","Ultima AGenda","Obs. Tecnico",
        "Complejidad","Complejidad[Audit]","NIT cliente ONYX","NIT cliente ONYX[Audit]", "Nombre cliente ONYX","Nombre cliente ONYX[Audit]", 
        "Nombre OT hija ONYX", "Nombre OT hija ONYX[Audit]","Número OT hija ONYX","Numero OT hija ONYX[Audit]",
        "Fecha creacion OT hija ONYX","Fecha creacion OT hija ONYX[Audit]",
        "Numero OT padre ONYX", "Numero OT padre ONYX[Audit]","Fecha Creacion OT padre ONYX ", "Fecha Creacion OT padre ONYX[Audit] ",
        "Contacto Tecnico OT padre ONYX", "Contacto Tecnico OT padre ONYX[Audit]",
        "Telefono tecnico OT padre ONYX",   "Telefono tecnico OT padre ONYX[Audit]",
        "Descripcion ONYX","Descripcion ONYX[Audit]","Direccion ONYX","Direccion ONYX[Audit]",
        "Segmento ONYX", "Segmento ONYX[Audit]","Tipo Servicio ONYX","Tipo Servicio ONYX[Audit]",
        "Servicios ONYX","Servicios ONYX[Audit]","Recurrente mensual ONYX","Recurrente Mensual[Audit]","Código servicio ONYX",
        "Código servicio ONYX[Audit]","Vendedor ONYX","Vendedor ONYX[Audit]","Teléfono Vendedor ONYX","Teléfono Vendedor ONYX[Audit]",
        "Estado OT hija ONYX","Estado OT hija ONYX[Audit]","Estado OT padre ONYX","Estado OT padre ONYX[Audit]",
        "Fecha compromiso OT padre ONYX","Fecha compromiso OT padre ONYX[Audit]",
        "OT Hija Resolucion 1 ONYX","OT Hija Resolucion 1 ONYX[Audit]","OT Hija Resolucion 2 ONYX","OT Hija Resolucion 2 ONYX[Audit]",
        "OT Hija Resolucion 3 ONYX","OT Hija Resolucion 3 ONYX[Audit]","OT Hija Resolucion 4 ONYX","OT Hija Resolucion 4 ONYX[Audit]",
    ...
    private static int REFRESH_MAX = 20000;
    private static int REFRESH_MIN = 5000;
    ...
    public void fillSqlList() {
        ...
        try {           
            ...
            tipoGeneralOrdenTrabajo = basicaMglFacadeLocal.findByTipoBasica(tipoGeneralOrdenId);
             // tipo de trabajo
            listTipoOtMgl = cmtTipoOtMglFacadeLocal.findAll();
    ...
    public void obtenerReporte() {
        try {
            ...
            if (validarFechaInicioOtOnyx() && filtroFechas != null) {
                processar();
    ...
    public void processar() throws ApplicationException {
        ...
        btnReporte = true;
        listReporteHistoricoOtCmDto = new ArrayList<ReporteHistoricoOtCmDto>();
        numRegAProcesar = ordenTrabajoMglFacadeLocal.findReporteHistoricoOtCmTotal(params, usuarioVT);
    ...
    public boolean IsStarted() {
        if (CmtReporteHistoricoOtCmDto.getNumeroRegistrosAProcesar() == 0) {
            iniciado = true;
        } else {
            iniciado = false;
        }
    ...
    public boolean IsFinished() {
        if (CmtReporteHistoricoOtCmDto.isIsFinished()) {
            finalizado = true;
        }
        return finalizado;
    }
    ...
    public boolean getReady() {
        if (CmtReporteHistoricoOtCmDto.getEndProcessDate() != null
                && !new Date().before(sumarTiempoFecha(CmtReporteHistoricoOtCmDto.getEndProcessDate(), this.minutos))) {
            limpiarValores();
            filtroFechas = null;
            setProgress(false);
            setFinish(false);
        ...
        if (this.progress) {
            this.finish = CmtReporteHistoricoOtCmDto.isIsFinished();
            if (this.finish) {
    ...
    public String downloadCvsTxtGen(List<ReporteHistoricoOtCmDto> listaCM,String ext) {
           try {
               ...
               if (!listaCM.isEmpty()) {
                   ...
                   if (numeroRegistros > 0) {
                           ...
                           sb.append("\n");
                            ...
                            for (ReporteHistoricoOtCmDto report : listReporteHistoricoOtCmDto) {

                                String otId = report.getOt_Id_Cm() == null ? " " : report.getOt_Id_Cm();
                                sb.append(otId);
                                sb.append(";");
                                String subtipoOt = report.getSub_tipo_OT_MER()== null ? " " :  StringUtils.stripAccents(report.getSub_tipo_OT_MER());
                                sb.append(subtipoOt);
                                sb.append(";");
                                String tipoOt = report.getTipo_OT_MER() == null ? " " :  StringUtils.stripAccents(report.getTipo_OT_MER());
                                sb.append(tipoOt);
                                sb.append(";");
                                String estadoOt = report.getEstado_interno_OT_MER() == null ? " " :  StringUtils.stripAccents(report.getEstado_interno_OT_MER());
                                sb.append(estadoOt);
                                sb.append(";");
                                String estadoOtAud = report.getEstado_interno_OT_MER_Aud()== null ? " " : StringUtils.stripAccents(report.getEstado_interno_OT_MER_Aud());
                                ...
                                String fechaModificacionOt = report.getFechaModificacionOtMer() == null ? " " : report.getFechaModificacionOtMer();
                                ...
                                sb.append(";");
                                 String segmentoOtAud = report.getSegmento_OT_MER_Aud()== null ? " " : report.getSegmento_OT_MER_Aud();
                                sb.append(segmentoOtAud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                String onyxOtCm = report.getOnyx_Ot_Hija_Cm() != null ? StringUtils.stripAccents(report.getOnyx_Ot_Hija_Cm()) : "";
                                sb.append(onyxOtCm);
                                sb.append(";");
                                String onyxOtCmAud = report.getOnyx_Ot_Hija_Cm_Aud()!= null ? StringUtils.stripAccents(report.getOnyx_Ot_Hija_Cm_Aud()) : "";
                                sb.append(onyxOtCmAud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                String subTipo_Orden_OFSC_Aud = report.getSubTipo_Orden_OFSC_Aud()!= null ? report.getSubTipo_Orden_OFSC_Aud() : "";
                                sb.append(subTipo_Orden_OFSC_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                String usuario_edicion_agenda_Aud = report.getUsuarioModAgendaAud()!= null ? report.getUsuarioModAgendaAud() : "";
                                sb.append(usuario_edicion_agenda_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                 String estado_agenda_OFSC_Aud = report.getEstado_agenda_OFSC_Aud()!= null ? report.getEstado_agenda_OFSC_Aud() : "";
                                sb.append(estado_agenda_OFSC_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                String fecha_inicia_agenda_OFSC_Aud = report.getFecha_inicia_agenda_OFSC_Aud()!= null ? report.getFecha_inicia_agenda_OFSC_Aud() : "";
                                sb.append(fecha_inicia_agenda_OFSC_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                String fecha_fin_agenda_OFSC_Aud = report.getFecha_fin_agenda_OFSC_Aud()!= null ? report.getFecha_fin_agenda_OFSC_Aud() : "";
                                sb.append(fecha_fin_agenda_OFSC_Aud);
                                sb.append(";");
                                String id_aliado_OFSC = report.getId_aliado_OFSC() != null ? report.getId_aliado_OFSC() : "";
                                sb.append(id_aliado_OFSC);
                                sb.append(";");
                                String id_aliado_OFSC_Aud = report.getId_aliado_OFSC_Aud()!= null ? report.getId_aliado_OFSC_Aud() : "";
                                sb.append(id_aliado_OFSC_Aud);
                                sb.append(";");
                                String nombre_aliado_OFSC = report.getNombre_aliado_OFSC() != null ? report.getNombre_aliado_OFSC() : "";
                                sb.append(nombre_aliado_OFSC);
                                sb.append(";");
                                String nombre_aliado_OFSC_Aud = report.getNombre_aliado_OFSC_Aud()!= null ? report.getNombre_aliado_OFSC_Aud() : "";
                                sb.append(nombre_aliado_OFSC_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                String id_tecnico_aliado_OFSC_Aud = report.getId_tecnico_aliado_OFSC_Aud()!= null ? report.getId_tecnico_aliado_OFSC_Aud() : "";
                                sb.append(id_tecnico_aliado_OFSC_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                String nombre_tecnico_aliado_OFSC_Aud = report.getNombre_tecnico_aliado_OFSC_Aud()!= null ? report.getNombre_tecnico_aliado_OFSC_Aud() : "";
                                sb.append(nombre_tecnico_aliado_OFSC_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                 String nombreOnyxAud = report.getNombre_Cliente_Onyx_Aud()!= null ? report.getNombre_Cliente_Onyx_Aud() : "";
                                sb.append(nombreOnyxAud);
                                sb.append(";");
                                String nomb_ot_hija = report.getNombre_Ot_Hija_Onyx() != null ? StringUtils.stripAccents(report.getNombre_Ot_Hija_Onyx()) : "";
                                sb.append(nomb_ot_hija);
                                sb.append(";");
                                String nomb_ot_hija_Aud = report.getNombre_OT_Hija_Onyx_Aud()!= null ? StringUtils.stripAccents(report.getNombre_OT_Hija_Onyx_Aud()) : "";
                                sb.append(nomb_ot_hija_Aud);
                                sb.append(";");
                                String numeroOtOnyx = report.getOnyx_Ot_Hija_Cm() != null ? StringUtils.stripAccents(report.getOnyx_Ot_Hija_Cm()) : "";
                                ...
                                sb.append(";");
                                String numeroOtPadre = report.getOnyx_Ot_Padre_Cm() != null ? report.getOnyx_Ot_Padre_Cm() : "";
                                sb.append(numeroOtPadre);
                                sb.append(";");
                                String numeroOtPadreAud = report.getOnyx_Ot_Padre_Cm_Aud()!= null ? report.getOnyx_Ot_Padre_Cm_Aud() : "";
                                ...
                                sb.append(";");
                                String descripcionOnyxAud = report.getDescripcion_Onyx_Aud()!= null ? report.getDescripcion_Onyx_Aud() : "";
                                ...
                                sb.append(";");
                                String direccionOnyxAud = report.getDireccion_Onyx_Aud()!= null ?  StringUtils.stripAccents(report.getDireccion_Onyx_Aud()) : "";
                                sb.append(direccionOnyxAud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                 String tipo_Servicio_Onyx_Aud = report.getTipo_Servicio_Onyx_Aud()!= null ? report.getTipo_Servicio_Onyx_Aud() : "";
                                sb.append(tipo_Servicio_Onyx_Aud);
                                sb.append(";");
                                String servicios_Onyx = report.getServicios_Onyx() != null ? report.getServicios_Onyx() : "";
                                sb.append(servicios_Onyx);
                                sb.append(";");
                                 String servicios_Onyx_Aud = report.getServicios_Onyx_Aud()!= null ? report.getServicios_Onyx_Aud() : "";
                                sb.append(servicios_Onyx_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                 String recurrente_Mensual_Onyx_Aud = report.getRecurrente_Mensual_Onyx_Aud()!= null ? report.getRecurrente_Mensual_Onyx_Aud() : "";
                                sb.append(recurrente_Mensual_Onyx_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                 String codigo_Servicio_Onyx_Aud = report.getCodigo_Servicio_Onyx_Aud()!= null ? report.getCodigo_Servicio_Onyx_Aud() : "";
                                sb.append(codigo_Servicio_Onyx_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                 String vendedor_Onyx_Aud = report.getVendedor_Onyx_Aud()!= null ? StringUtils.stripAccents(report.getVendedor_Onyx_Aud()) : "";
                                sb.append(vendedor_Onyx_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                   String telefono_Vendedor_Onyx_Aud = report.getTelefono_Vendedor_Onyx_Aud()!= null ? report.getTelefono_Vendedor_Onyx_Aud() : "";
                                sb.append(telefono_Vendedor_Onyx_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                 String estado_Ot_Hija_Onyx_Cm_Aud = report.getEstado_Ot_Hija_Onyx_Cm_Aud()!= null ? StringUtils.stripAccents(report.getEstado_Ot_Hija_Onyx_Cm_Aud()) : "";
                                sb.append(estado_Ot_Hija_Onyx_Cm_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                String estado_Ot_Padre_Onyx_Cm_Aud = report.getEstado_Ot_Padre_Onyx_Cm_Aud()!= null ? StringUtils.stripAccents(report.getEstado_Ot_Padre_Onyx_Cm_Aud()) : "";
                                sb.append(estado_Ot_Padre_Onyx_Cm_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                String fecha_Compromiso_Ot_Padre_Onyx_Aud = report.getFecha_Compromiso_Ot_Padre_Onyx_Aud()!= null ? report.getFecha_Compromiso_Ot_Padre_Onyx_Aud() : "";
                                sb.append(fecha_Compromiso_Ot_Padre_Onyx_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                 String ot_Hija_Resolucion_1_Onyx_Aud = report.getOt_Hija_Resolucion_1_Onyx_Aud()!= null ? StringUtils.stripAccents(report.getOt_Hija_Resolucion_1_Onyx_Aud()) : "";
                                sb.append(ot_Hija_Resolucion_1_Onyx_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                String ot_Hija_Resolucion_2_Onyx_Aud = report.getOt_Hija_Resolucion_2_Onyx_Aud()!= null ? StringUtils.stripAccents(report.getOt_Hija_Resolucion_2_Onyx_Aud()) : "";
                                sb.append(ot_Hija_Resolucion_2_Onyx_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                String ot_Hija_Resolucion_3_Onyx_Aud = report.getOt_Hija_Resolucion_3_Onyx_Aud()!= null ? StringUtils.stripAccents(report.getOt_Hija_Resolucion_3_Onyx_Aud()) : "";
                                sb.append(ot_Hija_Resolucion_3_Onyx_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                 String ot_Hija_Resolucion_4_Onyx_Aud = report.getOt_Hija_Resolucion_4_Onyx_Aud()!= null ? StringUtils.stripAccents(report.getOt_Hija_Resolucion_4_Onyx_Aud()) : "";
                                sb.append(ot_Hija_Resolucion_4_Onyx_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                String ot_Padre_Resolucion_1_Onyx_Aud = report.getOt_Padre_Resolucion_1_Onyx_Aud()!= null ? StringUtils.stripAccents(report.getOt_Padre_Resolucion_1_Onyx_Aud()) : "";
                                sb.append(ot_Padre_Resolucion_1_Onyx_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                 String ot_Padre_Resolucion_2_Onyx_Aud = report.getOt_Hija_Resolucion_2_Onyx_Aud()!= null ? StringUtils.stripAccents(report.getOt_Padre_Resolucion_2_Onyx_Aud()): "";
                                sb.append(ot_Padre_Resolucion_2_Onyx_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                 String ot_Padre_Resolucion_3_Onyx_Aud = report.getOt_Hija_Resolucion_3_Onyx_Aud()!= null ? StringUtils.stripAccents(report.getOt_Padre_Resolucion_3_Onyx_Aud()): "";
                                sb.append(ot_Padre_Resolucion_3_Onyx_Aud);
                                sb.append(";");
                                ...
                                sb.append(";");
                                String ot_Padre_Resolucion_4_Onyx_Aud = report.getOt_Hija_Resolucion_4_Onyx_Aud()!= null ? StringUtils.stripAccents(report.getOt_Padre_Resolucion_4_Onyx_Aud()): "";
                                sb.append(ot_Padre_Resolucion_4_Onyx_Aud);
                                sb.append(";");
                   ...
                   String fileName = "Historico_Ordenes_CCMM" + "_" + todayStr + "." + ext;
...
//            exportCsv(ext);
    ...
    public void mostralPanel() {
        ...
        } else if (filtroFechas.equals(Constant.FECHA_CREACION_OT_HIJA_ONYX)) {
    ...
    public int getNumRegProcesados() {
          numRegProcesados = CmtReporteHistoricoOtCmDto.getNumeroRegistrosProcesados();
    ...
    public List<ReporteHistoricoOtCmDto> getListReporteHistoricoOtCmDto() {
        return listReporteHistoricoOtCmDto;
    }

    public void setListReporteHistoricoOtCmDto(List<ReporteHistoricoOtCmDto> listReporteHistoricoOtCmDto) {
        this.listReporteHistoricoOtCmDto = listReporteHistoricoOtCmDto;
    }
    ...
    public List<CmtTipoOtMgl> getListTipoOtMgl() {
        return listTipoOtMgl;
    }

    public void setListTipoOtMgl(List<CmtTipoOtMgl> listTipoOtMgl) {
