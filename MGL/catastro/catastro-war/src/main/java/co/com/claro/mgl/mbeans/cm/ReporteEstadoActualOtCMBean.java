 ...
 * @author cardenaslb
 */
@ManagedBean(name = "reporteEstadoActualOtCMBean")
@SessionScoped
@Log4j2
public class ReporteEstadoActualOtCMBean {
    ...
    private List<ReporteOtCMDto> listReporteOtCMDto;
    ...
    private static String[] NOM_COLUMNAS = {
        "Numero Ot","Tipo OT MER", "SubTipo OT MER", "Est. Interno OT MER", "Fecha creacion OT MER","Fecha Modificacion OT","Estado de Ot",
        ...
        "OT hija ONYX","Departamento", "Complejidad ONYX","NIT cliente ONYX ", "Nombre cliente ONYX", "Nombre OT hija ONYX", "Numero OT hija ONYX","Fecha creacion OT hija ONYX",
        ...
        "Regional","Ciudad","Codigo Proyecto","Direccion Facturacion","Ciudad Facturacion","Indicador de cumplimiento de fecha de compromiso ",
        "Nombre persona contacto que confirmo","Email persona contacto que confirmo","Numero telefonico persona que confirmo",
    ...
    private List<String> listaTipoOt;
    private List<BigDecimal> tipoOrdenSelected;
    private List<CmtBasicaMgl> listBasicaSubtipoOrdenDirOFSC;
    private List<CmtBasicaMgl> listBasicaFinalSubtipoOrdenOFSC;
    private final String VALIDARREPORTRACKING = "VALIDARREPORTRACKING";
    
    
    public ReporteEstadoActualOtCMBean() {
        try {
    ...
    public void fillSqlList() {
        ...
        try {
            ...
            cantMaxRegExcel = Integer.parseInt(parametrosMglFacadeLocal.findParametroMgl(Constant.REPORTE_EXCEL_REG_MAX).getParValor());
            cantMaxRegCvs = Integer.parseInt(parametrosMglFacadeLocal.findParametroMgl(Constant.REPORTE_CVS_TXT_REG_MAX).getParValor());
            cantRegConsulta = Integer.parseInt(parametrosMglFacadeLocal.findParametroMgl(Constant.REPORTE_REG_MAX_CONSULTA).getParValor());
    ...
    public void getReporte() {
        try {
            ...
            if (blockReportServBean.isReportGenerationBlock("Reporte Estado Actual CCMM Y Direcciones")) return;
        } catch (ApplicationException e) {
   ...
   public void obtenerReporte() {
     ...
     public void processar() {
         ...
         try {
             ...
             btnReporte = true;
             listReporteOtCMDto = new ArrayList<ReporteOtCMDto>();
             numRegistrosResultado = ordenTrabajoMglFacadeLocal.findReporteOtCmTotal(params, usuarioVT);
...
public String downloadCvsTxtGen() {
        try {
            //Cantidad de registros por pagina a consultar de la DB            
            int expLonPag = cantRegConsulta;
            numRegistrosResultado = 0;
            List<ReporteOtCMDto> reporteOtResultList = new ArrayList();
            ...
            String fileName = "Reporte_Traking_Ordenes_Trabajo_Direcciones" + "_" + todayStr + "." + "csv";
        ...
        for (int exPagina = 1; exPagina <= ((totalPag/expLonPag)+ (totalPag%expLonPag != 0 ? 1: 0)); exPagina++) {    
            ...
            reporteOtResultList = ordenTrabajoMglFacadeLocal.findReporteOtCm(params, usuarioVT,
                    listaBasicaDir,
                    listaBasicaCm,
                    listacmtRegionalMgl,
                    listacmtComunidadRr,
                ...
                if (reporteOtResultList != null && !reporteOtResultList.isEmpty()) {
                    ...
                    for (ReporteOtCMDto report : reporteOtResultList) {
                        ...
                        if (sb.toString().length() > 1) {
                            sb.delete(0, sb.toString().length());
                                ...
                                sb.append(tipoOt);
                                sb.append(";");
                                String subTIpo = report.getTipo_OT_MER()== null ? " " : StringUtils.stripAccents(report.getTipo_OT_MER()); 
                                sb.append(subTIpo);
                                sb.append(";");
                                ...
                                sb.append(";");
                                String nombreCM = report.getNombreCMMER()== null ? " " : report.getNombreCMMER();
                                sb.append(nombreCM);
                                sb.append(";");
                                ...
                                //"OT hija ONYX","Departamento", "Complejidad ONYX","NIT cliente ONYX ", "Nombre cliente ONYX", "Nombre OT hija ONYX", "Numero OT hija ONYX","Fecha creación OT hija ONYX",
                                ...
                                sb.append(";");
                                String contactoTecnico = report.getContacto_Tecnico_Ot_Padre_Onyx() != null ? report.getContacto_Tecnico_Ot_Padre_Onyx() : "";
                                ...
                                sb.append(";");
                                String tipo_Servicio_Onyx = report.getTipo_Servicio_Onyx() != null ? StringUtils.stripAccents(report.getTipo_Servicio_Onyx()) : "";
                                ...
                                sb.append(";");
                                String estado_agenda_OFSC = report.getEstado_agenda_OFSC() != null ? StringUtils.stripAccents(report.getEstado_agenda_OFSC()) : "";
                                ...
                                sb.append(";");
                                String direccionFact = report.getDireccionFact()!= null ? StringUtils.stripAccents(report.getDireccionFact()) : "";
                                sb.append(direccionFact);
                                sb.append(";");
                                String ciudadFact = report.getCiudadFacturacion()!= null ? StringUtils.stripAccents(report.getCiudadFacturacion()) : "";
                                ...
                                String nombreTec = report.getContactoTecnicoOTP()!= null ? StringUtils.stripAccents(report.getContactoTecnicoOTP()) : "";
                                sb.append(nombreTec);
                                sb.append(";");
                                ...
                                sb.append(";");
                                String conveniencia = report.getConveniencia()!= null ? report.getConveniencia() : "";
                                sb.append(conveniencia);
                                sb.append(";");
 ...
 public String exportExcelDet() {
        try {
            ...
            String[] objArr = {
                "Numero Ot", "Tipo OT MER", "SubTipo OT MER", "Est. Interno OT MER", "Fecha creacion OT MER","Fecha Modificación OT MER","Estado de Ot",
                "Segmento OT MER", "Tecnologia OT MGL", "Codigo CCMM", "Direccion OT MER", "Codigo CCMM RR", "Nombre CCMM MER", "Usuario CREACION OT MER", "Usuario EDICION OT MER",
                "OT hija ONYX", "Departamento", "Complejidad ONYX", "NIT cliente ONYX ", "Nombre cliente ONYX", "Nombre OT hija ONYX", "Numero OT hija ONYX", "Fecha creacion OT hija ONYX",
                "Numero OT padre ONYX", "Fecha Creacion OT padre ONYX ", "Contacto Tecnico OT padre ONYX", "Telefono tecnico OT padre ONYX", "Descripcion ONYX",
                "Segmento ONYX", "Tipo Solucion ONYX", "Servicios ONYX", "Recurrente mensual ONYX", "Codigo servicio ONYX",
                ...
                "Regional", "Ciudad", "Codigo Proyecto", "Direccion Facturacion", "Ciudad Facturacion", "Indicador de cumplimiento de fecha de compromiso ",
                "Nombre persona contacto que confirmo", "Email persona contacto que confirmo", "Numero telefonico persona que confirmo",
                "Persona que Atiende", "Telefono persona atiende", "Tiempo de programacion", "Tiempo de atención compromiso", "Tiempo de ejecucion del trabajo",
                "Resultado de la orden de trabajo", "Antiguedad de Ot Onyx", "Cant Reagendas", "Conveniencia", "Motivos de Reagendas", "Aliado Implementacion"};
            ...
            for (int exPagina = 1; exPagina <= ((numRegistrosResultado / expLonPag) + (numRegistrosResultado % expLonPag != 0 ? 1 : 0));
                ...
                if (!reporteOtResultList.isEmpty()) {
                    for (ReporteOtCMDto a : reporteOtResultList) {
                        ...
                        if (rownum == 0) {
                            ...
                            cell2.setCellValue(a.getSub_tipo_OT_MER());
                            Cell cell3 = row.createCell(cellnum++);
                            cell3.setCellValue(a.getTipo_OT_MER());
                            ...
                            cell9.setCellValue(a.getNombreCMMER());
                            ...
                            cell62.setCellValue(a.getDireccionFact() != null ? a.getDireccionFact() : "");
                            Cell cell622 = row.createCell(cellnum++);
                            cell622.setCellValue(a.getCiudadFacturacion() != null ? a.getCiudadFacturacion() : "");
                            ...
                            //"Nombre persona contacto que confirmó","Email persona contacto que confirmo","Número telefónico persona que confirmo",
                            cell644.setCellValue(a.getContactoTecnicoOTP() != null ? a.getContactoTecnicoOTP() : "");
            ...
            response.setHeader("Content-Disposition", "attachment; filename=\""
                    + "Reporte_actual_Ordenes_Ccmm_Direcciones" + "_" + formato.format(new Date())
                    + ".xlsx\"");
    ...
    public boolean validarFechaInicioSuspension() {
        ...
        public boolean validarOtInicioFin() {
        boolean respuesta = false;
        try {
                if (otFin != null && otIni != null) {
                     ...
                     FacesContext.getCurrentInstance().addMessage(null,
                        new FacesMessage(FacesMessage.SEVERITY_WARN,
                                "Ud no ha seleccionado un rango de ot", ""));
                     return respuesta = false;
                }
    ...
    public boolean validarFiltrosVarios() {
        boolean respuesta = false;
        try {
            ...
            if (valor != null && !valor.isEmpty() ) {
                ...
                FacesContext.getCurrentInstance().addMessage(null,
                        new FacesMessage(FacesMessage.SEVERITY_WARN,
                                "Ud no ha seleccionado un valor ", ""));
                return respuesta = false;
            }
    ...
    public void buscar() {
        ...
        params.put("fechaInicioOtHijaOnyx", this.fechaInicioOtHijaOnyx);
        params.put("fechaFinOtHijaOnyx", this.fechaFinOtHijaOnyx);
        ...
        params.put("fechaCreacionIniOnyx", this.fechaCreacionIniOnyx);
        params.put("fechaCreacionFinOnyx", this.fechaCreacionFinOnyx);
        //ordenes 
        ...
        try {
            ...
            if (((List<BigDecimal>) params.get("listRegionalSelected")) != null 
                    && !((List<BigDecimal>) params.get("listRegionalSelected")).isEmpty()) {
            ...
            String msgError = "Error " + ClassUtils.getCurrentMethodName(this.getClass()) + ": " + ex.getMessage();
       ...
       // codigo de ciudades
        try {
            ...
            if (((List<BigDecimal>) params.get("listRrCiudadesSelected")) != null
                    && !((List<BigDecimal>) params.get("listRrCiudadesSelected")).isEmpty()) {
    ...
    public void cargarListaEstadosIntExt() throws ApplicationException {
      ...
      public boolean validarReporteTracking() {
        return validarEdicion(VALIDARREPORTRACKING);
    }
    ...
    public List<ReporteOtCMDto> getListCmtCuentaMatrizMglCompComercial() {
        return listReporteOtCMDto;
    }

    public void setListCmtCuentaMatrizMglCompComercial(List<ReporteOtCMDto> listCmtCuentaMatrizMglCompComercial) {
        this.listReporteOtCMDto = listReporteOtCMDto;
    }
    ...
    public List<ReporteOtCMDto> getListReporteOtCMDto() {
        return listReporteOtCMDto;
    }

    public void setListReporteOtCMDto(List<ReporteOtCMDto> listReporteOtCMDto) {
        this.listReporteOtCMDto = listReporteOtCMDto;
    }
    ...
    public List<String> getListaTipoOt() {
        return listaTipoOt;
    }

    public void setListaTipoOt(List<String> listaTipoOt) {
        this.listaTipoOt = listaTipoOt;
    }

    public List<BigDecimal> getTipoOrdenSelected() {
        return tipoOrdenSelected;
    }

    public void setTipoOrdenSelected(List<BigDecimal> tipoOrdenSelected) {
