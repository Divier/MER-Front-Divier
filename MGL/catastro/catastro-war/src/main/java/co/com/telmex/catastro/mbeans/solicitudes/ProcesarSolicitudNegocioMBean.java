...
import co.com.telmex.catastro.data.ObjetoRrCreacion;
 ...
 */
@SessionScoped
@ManagedBean(name = "procesarSolicitudNegocioMBean")
public class ProcesarSolicitudNegocioMBean extends BaseMBean implements Serializable {

    private static final Logger LOGGER = LogManager.getLogger(ProcesarSolicitudNegocioMBean.class);

    private static String NOMBRE_FUNCIONALIDAD = "PROCESAR SOLICITUD DE NEGOCIO";
    ...
    private boolean renderedValidar = true;
    private boolean renderedDescargar = false;
    private boolean showpopUp = false;
    private boolean disableTs = false;
    private String messagePopup = "¿Esta seguro que desea procesar las solicitudes de creación de HHPP y Generar archivo para RR?";
    private List<SolicitudNegocio> solicitudes = null;
    private List<SolicitudNegocio> solicitudesRr = null;
    private String nombreArchivo = "";
    private List<ObjetoRrCreacion> objetosRR = null;
    int contador = 2;
    int qSolicitudes = 0;
     ...
     * @throws IOException
     */
    public ProcesarSolicitudNegocioMBean()  {
        super();
    ...
    public void onActionProcesar() {
        ...
        try {
            if (solicitudes.size() > 0) {
                ...
                message = SolicitudNegocioDelegate.procesarSolicitudesNegocio(solicitudes, NOMBRE_FUNCIONALIDAD, nombreArchivo, user.getUsuLogin());
                crearObjetosRR();
        ...
        if (message.isEmpty()) {
            try {
                ...
                if (solicitudesRr != null && solicitudesRr.size() > 0) {
                    objetosRR = new ArrayList<ObjetoRrCreacion>();
                    for (SolicitudNegocio solicitud : solicitudesRr) {
                        ObjetoRrCreacion objeto = new ObjetoRrCreacion();
                        Nodo nodo = solicitud.getNodo();
                        objeto.setComunidad(nodo.getComunidad().getComId());
                        ...
                        objeto.setBarrio(barrio);
                        objeto.setVendedor(Constant.CODIGO_VENDEDOR_RR);
                        String estrato = Constant.NG_RR;
                        if (solicitud.getSonEstrato() != null && !solicitud.getSonEstrato().equals("")) {
                            estrato = solicitud.getSonEstrato();
                        } else if (solicitud.getSonNivSocioeconomico() != null && !solicitud.getSonNivSocioeconomico().equals("")) {
                            estrato = solicitud.getSonNivSocioeconomico();
                        }
                        objeto.setEstrato(estrato);
                        objeto.setZipCode(nodo.getComunidad().getComZipcode());
                        objeto.setTipoUnidad(solicitud.getTipoHhpp().getThhId());
                        objeto.setGrid(nodo.getComunidad().getComId());
                        objeto.setTipoAcometida(solicitud.getTipoHhppConexion().getThcCodigo());
                        objeto.setCable(Constant.CABLE_RR);
                        objeto.setPropCable(Constant.VACIO_RR);
                        objeto.setCampo1(Constant.VACIO_RR);
                        objeto.setCampo2(Constant.VACIO_RR);
                        DateFormat dateFormat = new SimpleDateFormat("yyyyMMdd");
                        objeto.setFecha(dateFormat.format(new Date()));
                        objeto.setCodigoHeadEnd(solicitud.getSonHeadEnd());
                        objeto.setCampoNd(Constant.CAMPO_ND_RR);
                        objeto.setCodigoNodo(nodo.getNodCodigo());
                        objeto.setSpigot(Constant.VACIO_RR);
                        objeto.setDirAlterna(solicitud.getSonDiralterna());
                        objeto.setLocalidad(solicitud.getSonLocalidad());
                        objeto.setLadoMz(solicitud.getSonLadomz());
                        String manzana = Constant.NG_RR;
                        if (solicitud.getSonManzanaCatastral() != null && !solicitud.getSonManzanaCatastral().equals("")) {
                            manzana = solicitud.getSonManzanaCatastral();
                        }
                        objeto.setManzana(manzana);
                        String notaLinea1 = "SOLICITUD " + solicitud.getSonId() + " SOLICITANTE " + solicitud.getSonNomSolicitante();
                        objeto.setNotaLinea1(notaLinea1);
                        objeto.setNotaLinea2(solicitud.getSonAreaSolicitante());
                        objeto.setNotaLinea3("NODO " + nodo.getNodCodigo());
                        objeto.setNotaLinea4(Constant.VACIO_RR);
                        objeto.setNotaLinea5(Constant.VACIO_RR);
                        objeto.setCampo3("0");
                        objeto.setCampo4(Constant.VACIO_RR);
                        objetosRR.add(objeto);
                    }
                }
            } catch (ApplicationException e) {
                String msg = "Se produjo un error al momento de ejecutar el método '" + ClassUtils.getCurrentMethodName(this.getClass()) + "': " + e.getMessage();
    ...
    /*
     * Cancelar el procesamiento de solicitudes de creación
     */
    /**
     *
     */
    ...
    public void doExportObjectsToCSV() {
        ...
        if (objetosRR != null) {
            for (ObjetoRrCreacion data : this.objetosRR) {
                sb.append(data.getDivision());
                sb.append(SEPARATOR);
                sb.append(data.getComunidad());
                sb.append(SEPARATOR);
                sb.append(data.getCalle());
                sb.append(SEPARATOR);
                sb.append(data.getPlaca());
                sb.append(SEPARATOR);
                sb.append(data.getApto());
                sb.append(SEPARATOR);
                sb.append(data.getBarrio());
                sb.append(SEPARATOR);
                sb.append(data.getVendedor());
                sb.append(SEPARATOR);
                sb.append(data.getEstrato());
                sb.append(SEPARATOR);
                sb.append(data.getZipCode());
                sb.append(SEPARATOR);
                sb.append(data.getTipoUnidad());
                sb.append(SEPARATOR);
                sb.append(data.getGrid());
                sb.append(SEPARATOR);
                sb.append(data.getTipoAcometida());
                sb.append(SEPARATOR);
                sb.append(data.getCable());
                sb.append(SEPARATOR);
                sb.append(data.getPropCable());
                sb.append(SEPARATOR);
                sb.append(data.getCampo1());
                sb.append(SEPARATOR);
                sb.append(data.getCampo2());
                sb.append(SEPARATOR);
                sb.append(data.getFecha());
                sb.append(SEPARATOR);
                sb.append(data.getCodigoHeadEnd());
                sb.append(SEPARATOR);
                sb.append(data.getCampoNd());
                sb.append(SEPARATOR);
                sb.append(data.getCodigoNodo());
                sb.append(SEPARATOR);
                sb.append(data.getSpigot());
                sb.append(SEPARATOR);
                sb.append(data.getDirAlterna());
                sb.append(SEPARATOR);
                sb.append(data.getLocalidad());
                sb.append(SEPARATOR);
                sb.append(data.getLadoMz());
                sb.append(SEPARATOR);
                sb.append(data.getManzana());
                sb.append(SEPARATOR);
                sb.append(data.getNotaLinea1());
                sb.append(SEPARATOR);
                sb.append(data.getNotaLinea2());
                sb.append(SEPARATOR);
                sb.append(data.getNotaLinea3());
                sb.append(SEPARATOR);
                sb.append(data.getNotaLinea4());
                sb.append(SEPARATOR);
                sb.append(data.getNotaLinea5());
                sb.append(data.getCampo3());
                sb.append(SEPARATOR);
                sb.append(data.getCampo4());
                sb.append(SEPARATOR);
                sb.append("\n");
            }
            byte[] csvData = null;
            try {
                ...
                LOGGER.error(message + " EX000: " + ex.getMessage(), ex);
            } catch (Exception e) {
                message = "Se produjo un error al Escribir el archivo: " + e.getMessage();
            ...
            message = "No existen HHPP para crear en RR.";
        }
    }
    ...
    private String calcularNombreArchivo() {
        ...
        fileName = fileName + dateFormat.format(fechaActual) + ts + ".csv";
        return fileName;
    }
     ...
     * @return
     */
    public boolean isRenderedValidar() {
        return renderedValidar;
    }

    /**
     *
     * @param renderedValidar
     */
    public void setRenderedValidar(boolean renderedValidar) {
        this.renderedValidar = renderedValidar;
    }
     ...
     * @param qSolicitudes
     */
    public void setqSolicitudes(int qSolicitudes) {
        this.qSolicitudes = qSolicitudes;
    }
}
