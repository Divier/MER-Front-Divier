	...
	Vanadium
			.addValidatorTypes( [
					...
					[
							...
							"<br> Por favor, introduzca un número entero válido en este campo." ],
					[
							"number",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
							...
							"<br> Por favor, introduzca un n&uacute;mero v&aacute;lido en este campo." ],
					[
							"float",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
							...
							"<br> Por favor, introduzca un número válido en este campo." ],
					[
							"digits",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
							...
							"<br> Por favor, use solo numeros en este campo. Por favor, evite espacios u otros caracteres, tales como puntos o comas." ],
					[
							"alpha",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
										|| /^[a-zA-Z\u00C0-\u00FF\u0100-\u017E\u0391-\u03D6]+$/
												.test(a)
							}, "<br> Por favor, use solo letras en este campo." ],
					[
							"asciialpha",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
