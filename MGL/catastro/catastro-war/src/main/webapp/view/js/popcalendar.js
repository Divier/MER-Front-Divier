	...
	var imgDir = "view/img/"			// directory for images ... e.g. var imgDir="/img/"
	...
	var	imgsrc = new Array("../img/drop1.gif","../img/drop2.gif","../img/left1.gif","../img/left2.gif","../img/right1.gif","../img/right2.gif")
	var	img	= new Array()
