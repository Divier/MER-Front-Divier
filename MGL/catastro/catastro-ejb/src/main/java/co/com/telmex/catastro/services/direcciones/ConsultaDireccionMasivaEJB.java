...
/**
 * Clase ConsultaDireccionMasivaEJB implementa ConsultaDireccionMasivaEJBRemote
 *
 * @author Ana María Malambo.
 * @version	1.0
 */
@Stateless(name = "consultaDireccionEJB", mappedName = "consultaDireccionEJB", description = "consultaDireccion")
@Remote({ConsultaDireccionMasivaEJBRemote.class})
public class ConsultaDireccionMasivaEJB implements ConsultaDireccionMasivaEJBRemote {

    private static final Logger LOGGER = LogManager.getLogger(ConsultaDireccionMasivaEJB.class);
    ...
    public boolean existAddressRepo(String dirFormatoIGAC) throws ApplicationException {
        ...
        try {
            ...
            LOGGER.error(msg);
            DireccionUtil.closeConnection(adb);
            throw new ApplicationException("Error al verificar la existencia de la dirección. EX000: " + e.getMessage(), e);
        }
    }
    ...
    public boolean existSubAddressRepo(String subdirFormatoIGAC) throws ApplicationException {
        ...
        try {
            ...
            LOGGER.error(msg);
            DireccionUtil.closeConnection(adb);
            throw new ApplicationException("Error al verificar la existencia de la subdirección. EX000: " + e.getMessage(), e);
        }
    }
}
