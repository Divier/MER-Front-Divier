 ...
 * @author cardenaslb
 */
public class CmtReporteEstadoActualOtDirHhppDto {
    
    
    private static List<ReporteOtDIRDto> listReporteOtDIRDto;
    private static List<ReporteOtDIRDto> listSolicitudesTotalesReport;
    ...
    public static void startProcess(String user) throws ApplicationException {
        ...
        listReporteOtDIRDto = new LinkedList<ReporteOtDIRDto>();
    ...
    public static void endProcess(List<ReporteOtDIRDto> resultado) throws ApplicationException {
        if (!isProcessing) {
            throw new ApplicationException("No hay ningun proceso en ejecucion");
        }
        listReporteOtDIRDto = resultado;
        isProcessing = false;
        isFinished = true;
    ...
    public static List<ReporteOtDIRDto> getListReporteOtDIRDto() {
        return listReporteOtDIRDto;
    }

    public static void setListReporteOtDIRDto(List<ReporteOtDIRDto> listReporteOtDIRDto) {
        CmtReporteEstadoActualOtDirHhppDto.listReporteOtDIRDto = listReporteOtDIRDto;
    }

    public static List<ReporteOtDIRDto> getListSolicitudesTotalesReport() {
        return listSolicitudesTotalesReport;
    }

    public static void setListSolicitudesTotalesReport(List<ReporteOtDIRDto> listSolicitudesTotalesReport) {
        CmtReporteEstadoActualOtDirHhppDto.listSolicitudesTotalesReport = listSolicitudesTotalesReport;
    }
    ...
    public static void setNumeroRegistrosAProcesar(int numeroRegistrosAProcesar) {
        CmtReporteEstadoActualOtDirHhppDto.numeroRegistrosAProcesar = numeroRegistrosAProcesar;
    }
    ...
    public static void setNumeroRegistrosProcesados(int numeroRegistrosProcesados) {
        CmtReporteEstadoActualOtDirHhppDto.numeroRegistrosProcesados = numeroRegistrosProcesados;
    }
    ...
    public static void setIsProcessing(boolean isProcessing) {
        CmtReporteEstadoActualOtDirHhppDto.isProcessing = isProcessing;
    }
    ...
    public static void setIsFinished(boolean isFinished) {
        CmtReporteEstadoActualOtDirHhppDto.isFinished = isFinished;
    }
    ...
    public static void setUserRunningProcess(String userRunningProcess) {
        CmtReporteEstadoActualOtDirHhppDto.userRunningProcess = userRunningProcess;
    }
    ...
    public static void setStartProcessDate(Date startProcessDate) {
        CmtReporteEstadoActualOtDirHhppDto.startProcessDate = startProcessDate;
    }
    ...
    public static void setEndProcessDate(Date endProcessDate) {
        CmtReporteEstadoActualOtDirHhppDto.endProcessDate = endProcessDate;
    }
    ...
    public static void setMessage(String message) {
        CmtReporteEstadoActualOtDirHhppDto.message = message;
    }
