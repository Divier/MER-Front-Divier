 ...
 * @author bocanegravm
 */
public interface ArrendatarioMglFacadeLocal {
     ...
     */
    List<ArrendatarioMgl> findAll() throws ApplicationException;
     ...
     * @throws ApplicationException
     */
    ArrendatarioMgl create(ArrendatarioMgl arrendatarioMgl, String mUser, int mPerfil)
            throws ApplicationException;
     ...
     * @throws ApplicationException
     */
    ArrendatarioMgl update(ArrendatarioMgl arrendatarioMgl, String mUser, int mPerfil)
            throws ApplicationException;
     ...
     * @throws ApplicationException
     */
    boolean delete(ArrendatarioMgl arrendatarioMgl, String mUser, int mPerfil)
            throws ApplicationException;
     ...
     * @throws ApplicationException
     */
    List<AuditoriaDto> construirAuditoria(ArrendatarioMgl arrendatarioMgl)
     ...
     * @throws ApplicationException
     */
    List<ArrendatarioMgl> findArrendatariosByCentro(GeograficoPoliticoMgl centro) throws ApplicationException;
     ...
     * @throws ApplicationException
     */
    GetActivityBookingResponses consultarCuadrante(NodoMgl nodo)
            throws ApplicationException;
     ...
     * @throws ApplicationException
     */
    ArrendatarioMgl findArrendatariosByCentroAndCityAndDpto
        (GeograficoPoliticoMgl centro, GeograficoPoliticoMgl ciudad,
     ...
     * @throws ApplicationException
     */
    ArrendatarioMgl findByCentroAndNombreArrendaAndCuadrante
     ...
     * @throws ApplicationException
     */
     ArrendatarioMgl findArrendatariosById(BigDecimal id)
            throws ApplicationException;  
      ...
      * @throws ApplicationException 
      */
     List<ArrendatarioMgl> findArrendatariosByFiltro
        (CmtFiltroConsultaArrendatarioDto filtro) throws ApplicationException;
}
