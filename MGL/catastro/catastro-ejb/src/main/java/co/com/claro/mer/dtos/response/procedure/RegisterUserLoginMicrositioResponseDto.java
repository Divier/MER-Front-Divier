...
/**
 * Clase que representa el DTO de respuesta del procedimiento almacenado para registrar la sesión del usuario de micrositio.
 *
...
@NoArgsConstructor
@ToString
public class RegisterUserLoginMicrositioResponseDto {
