 ...
 * @author cardenaslb
 */
public class ReporteOtCMDto {
    
    
    private BigDecimal id_OnyxCmDir;
    private String ot_Id_Cm;
    private BigDecimal ot_Direccion_Id;
    ...
    private String fechaCreacionOtOnyx;
    ...
    public BigDecimal getOt_Direccion_Id() {
        return ot_Direccion_Id;
    }

    public void setOt_Direccion_Id(BigDecimal ot_Direccion_Id) {
    ...
    public String getNombreCMMER() {
        return nombreCMMER;
    }

    public void setNombreCMMER(String nombreCMMER) {
        this.nombreCMMER = nombreCMMER;
    }
    ...
    public String getFechaCreacionOtOnyx() {
        return fechaCreacionOtOnyx;
    }

    public void setFechaCreacionOtOnyx(String fechaCreacionOtOnyx) {
        this.fechaCreacionOtOnyx = fechaCreacionOtOnyx;
    }
