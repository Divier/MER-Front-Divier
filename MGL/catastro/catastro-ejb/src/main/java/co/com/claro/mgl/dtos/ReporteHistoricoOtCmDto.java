 ...
 * @author cardenaslb
 */
public class ReporteHistoricoOtCmDto {
    ...
    private String fechaModificacionOtMer;
    ...
    public String getFechaModificacionOtMer() {
        return fechaModificacionOtMer;
    }

    public void setFechaModificacionOtMer(String fechaModificacionOtMer) {
        this.fechaModificacionOtMer = fechaModificacionOtMer;
    }
