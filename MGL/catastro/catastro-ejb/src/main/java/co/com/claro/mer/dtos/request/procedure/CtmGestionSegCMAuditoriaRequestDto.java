...
/**
 * DTO que representa el request de entrada del procedimiento CMT_GESTI_SEG_CM_AUD_PKG.CMT_GESTI_SEG_CM_AUD_PRC
 *
...
@AllArgsConstructor
@NoArgsConstructor
public class CtmGestionSegCMAuditoriaRequestDto {
