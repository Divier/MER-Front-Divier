...
/**
 * <p>Clase Java para TypePropertyElementCr complex type.
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera
 * que haya en esta clase.
 *
 * <pre>
 * &lt;complexType name="TypePropertyElementCr"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "TypePropertyElement", propOrder = {
    "label",
    "value"
})
public class TypePropertyElementCr {

    /**
     *
     */
    public TypePropertyElementCr() {
    }
     ...
     * @param value
     */
    public TypePropertyElementCr(String label, String value) {
        this.label = label;
        this.value = value;
    }
    /**
