...
/**
 * <p>Clase Java para MgwTypeAgendarRequestElement complex type.
 *
 ...
 * WS_SIEC_CrearOrdenMGWInbound}TypeDataElementCr"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class MgwTypeAgendarRequestElement {
     ...
     */
    @XmlElement(required = true)
    protected TypeDataElementCr data;
     ...
     *
     * @return possible object is {@link TypeDataElementCr }
     *
     */
    public TypeDataElementCr getData() {
        return data;
    }
     ...
     *
     * @param value allowed object is {@link TypeDataElementCr }
     *
     */
    public void setData(TypeDataElementCr value) {
        this.data = value;
    }
