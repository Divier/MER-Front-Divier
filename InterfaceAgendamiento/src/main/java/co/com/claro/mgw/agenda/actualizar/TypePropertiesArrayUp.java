 ...
 * ect/WS_SIEC_RealizarReagendacionMGWInbound}TypePropertyElement" maxOccurs=
...
public class TypePropertiesArrayUp
{
    /**
     * 
     */
    public TypePropertiesArrayUp()
    {}
     ...
     * @param property 
     */
    public TypePropertiesArrayUp(List<TypePropertyElementUp> property)
    {
     ...
     *
     */
    protected List<TypePropertyElementUp> property;
     ...
     * @return 
     */
    public List<TypePropertyElementUp> getProperty()
    {
        if (property == null)
        {
     ...
     * @param c 
     */
    public void add(TypePropertyElementUp c)
    {
        if (property == null)
        {
            property = new ArrayList();
