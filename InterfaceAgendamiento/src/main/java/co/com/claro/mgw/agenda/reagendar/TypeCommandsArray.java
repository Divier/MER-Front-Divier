...
public class TypeCommandsArray
{
    /**
     * 
     * @param command 
     */
    public TypeCommandsArray(List<TypeCommandElement> command)
    {
    ...
    protected List<TypeCommandElement> command;
     ...
     * @return 
     */
    public List<TypeCommandElement> getCommand()
    {
        if (command == null)
        {
     ...
     * @param c 
     */
    public void add(TypeCommandElement c)
    {
        if (command == null)
        {
            command = new ArrayList();
