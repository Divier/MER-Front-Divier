...
/**
 * <p>Clase Java para TypeHeadResponseElement complex type.
 *
 ...
 * string"/&gt;
 *         &lt;element name="idTransaccion" type="{http://www.w3.org/2001/XMLSc
 * hema}string"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
...
public class TypeHeadResponseElement {
    ...
    public TypeHeadResponseElement() {
    }

    public TypeHeadResponseElement(String date, String idTransaccion) {
        this.date = date;
