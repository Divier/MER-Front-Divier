...
@XmlType(name = "TypeHeadElement", propOrder = {
    "date",
    "idTransaccion"
})
public class MgwHeadElement {

    /**
     *
     */
    public MgwHeadElement() {
    }
     ...
     * @param idTransaccion
     */
    public MgwHeadElement(String date, String idTransaccion) {
        this.date = date;
