...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        ...
        resources.add(co.com.claro.CMatricesAs400Service.war.restful.RestAgendamientosOtServices.class);
        resources.add(co.com.claro.CMatricesAs400Service.war.restful.RestCuentasMatrices.class);
        resources.add(co.com.claro.CMatricesAs400Service.war.restful.RestMglService.class);
