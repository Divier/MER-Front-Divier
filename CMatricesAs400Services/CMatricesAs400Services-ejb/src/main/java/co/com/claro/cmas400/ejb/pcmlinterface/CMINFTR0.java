...
@Program(programName = "CMINFTR0", documentName = "co.com.claro.cmas400.ejb.pcml.CMINFTR0")
public class CMINFTR0 {
    ...
    @Array(pcmlName = "TABLARTA", size = 600, type = java.lang.String.class, usage = UsageType.INPUTOUTPUT)
