...
@Program(programName = "CMCXEFR0", documentName = "co.com.claro.cmas400.ejb.pcml.CMCXEFR0")
public class CMCXEFR0 {

    @Data(pcmlName = "CUENTA", usage = UsageType.INPUTOUTPUT)
    private String CUENTA = new String();
    @Data(pcmlName = "PCML", usage = UsageType.INPUTOUTPUT)
    private String PCML = new String();
    @Data(pcmlName = "PNOPCI", usage = UsageType.INPUTOUTPUT)
    private String PNOPCI = new String();
    ...
    public String getPNOPCI() {
        return PNOPCI;
    }

    public void setPNOPCI(String PNOPCI) {
        this.PNOPCI = PNOPCI;
    }
