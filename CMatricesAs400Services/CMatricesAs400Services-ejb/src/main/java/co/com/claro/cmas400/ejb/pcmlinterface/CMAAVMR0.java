...
@Program(programName = "CMAAVMR0", documentName = "co.com.claro.cmas400.ejb.pcml.CMAAVMR0")
public class CMAAVMR0 {
    ...
    @Array(pcmlName = "TABLARTA", size = 750, type = java.lang.String.class, usage = UsageType.INPUTOUTPUT)
