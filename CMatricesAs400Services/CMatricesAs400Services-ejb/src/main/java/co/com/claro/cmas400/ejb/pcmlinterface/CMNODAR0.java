...
@Program(programName = "CMNODAR0", documentName = "co.com.claro.cmas400.ejb.pcml.CMNODAR0")
public class CMNODAR0 {
    ...
    @Array(pcmlName = "TABLARTA", size = 1350, type = java.lang.String.class, usage = UsageType.INPUTOUTPUT)
