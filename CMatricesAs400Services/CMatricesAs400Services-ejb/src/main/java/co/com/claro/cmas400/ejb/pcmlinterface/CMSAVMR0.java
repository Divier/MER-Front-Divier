...
@Program(programName = "CMSAVMR0", documentName = "co.com.claro.cmas400.ejb.pcml.CMSAVMR0")
public class CMSAVMR0 {
    ...
    @Array(pcmlName = "TABLARTA", size = 800, type = java.lang.String.class, usage = UsageType.INPUTOUTPUT)
