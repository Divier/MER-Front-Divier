...
@Program(programName = "CMNDINR0", documentName = "co.com.claro.cmas400.ejb.pcml.CMNDINR0")
public class CMNDINR0 {

    @Data(pcmlName = "PCML", usage = UsageType.INPUTOUTPUT)
    private String PCML = new String();
    @Data(pcmlName = "PDCODQ", usage = UsageType.INPUTOUTPUT)
    private String PDCODQ = new String();
    ...
    public String getPDCODQ(){
      return PDCODQ;
    }

    public void setPDCODQ(String PDCODQ){
      this.PDCODQ = PDCODQ;
    }
