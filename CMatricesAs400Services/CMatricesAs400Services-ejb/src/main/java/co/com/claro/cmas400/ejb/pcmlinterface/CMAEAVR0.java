...
@Program(programName = "CMAEAVR0", documentName = "co.com.claro.cmas400.ejb.pcml.CMAEAVR0")
public class CMAEAVR0 {

    @Data(pcmlName = "PCML", usage = UsageType.INPUTOUTPUT)
    private String PCML = new String();
    @Data(pcmlName = "CTAMAT", usage = UsageType.INPUTOUTPUT)
    private String CTAMAT = new String();
    @Data(pcmlName = "SUBEDIFC", usage = UsageType.INPUTOUTPUT)
    private String SUBEDIFC = new String();
    ...
    @Array(pcmlName = "TABLARTA", size = 100, type = java.lang.String.class, usage = UsageType.INPUTOUTPUT)
    ...
    public String getSUBEDIFC() {
        return SUBEDIFC;
    }

    public void setSUBEDIFC(String SUBEDIFC) {
        this.SUBEDIFC = SUBEDIFC;
    }
