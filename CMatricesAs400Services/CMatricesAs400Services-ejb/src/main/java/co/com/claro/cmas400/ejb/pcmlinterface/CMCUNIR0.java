...
@Program(programName = "CMCUNIR0", documentName = "co.com.claro.cmas400.ejb.pcml.CMCUNIR0")
public class CMCUNIR0 {

    @Data(pcmlName = "PAEDIF", usage = UsageType.INPUTOUTPUT)
    private String PAEDIF = new String();
    @Data(pcmlName = "PUSCON", usage = UsageType.INPUTOUTPUT)
    private String PUSCON = new String();
    ...
    public String getPUSCON() {
        return PUSCON;
    }

    public void setPUSCON(String PUSCON) {
        this.PUSCON = PUSCON;
    }
