...
@Program(programName = "CMCRNFR1", documentName = "co.com.claro.cmas400.ejb.pcml.CMCRNFR1")
public class CMCRNFR1 {
    
    @Data(pcmlName = "PAEDIF", usage = UsageType.INPUTOUTPUT)
    private String PAEDIF = new String();
    @Data(pcmlName = "PASEDI", usage = UsageType.INPUTOUTPUT)
    private String PASEDI = new String();
    @Data(pcmlName = "PANUTR", usage = UsageType.INPUTOUTPUT)
    private String PANUTR = new String();
    ...
    public String getPASEDI() {
        return PASEDI;
    }

    public void setPASEDI(String PASEDI) {
        this.PASEDI = PASEDI;
    }

    public String getPANUTR() {
        return PANUTR;
    }

    public void setPANUTR(String PANUTR) {
        this.PANUTR = PANUTR;
    }
