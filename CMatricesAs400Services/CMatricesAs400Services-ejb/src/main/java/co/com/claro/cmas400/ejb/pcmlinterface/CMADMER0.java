...
@Program(programName = "CMADMER0", documentName = "co.com.claro.cmas400.ejb.pcml.CMADMER0")
public class CMADMER0 {
    ...
    @Array(pcmlName = "TABLARTA", size = 300, type = java.lang.String.class, usage = UsageType.INPUTOUTPUT)
