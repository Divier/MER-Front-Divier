...
@Program(programName = "CMCTRFR2", documentName = "co.com.claro.cmas400.ejb.pcml.CMCTRFR2")
public class CMCTRFR2 {

    @Data(pcmlName = "PAEDIF", usage = UsageType.INPUTOUTPUT)
    private String PAEDIF = new String();
    @Data(pcmlName = "PNSEQU", usage = UsageType.INPUTOUTPUT)
    private String PNSEQU = new String();
    ...
    public String getPNSEQU() {
        return PNSEQU;
    }

    public void setPNSEQU(String PNSEQU) {
        this.PNSEQU = PNSEQU;
    }
